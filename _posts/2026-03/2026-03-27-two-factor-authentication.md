...
真正有效嘅 2FA 要 **跨類別組合** 因素。用兩個「你知道」既嘢（密碼 + 安全問題）唔算真正既 2FA。
...
**SMS** 方便但有已知漏洞——SIM swap 攻擊可以截獲你既驗證碼。
...
真正既 2FA 係幫你 **每個服務** 都加多層保護 —— 就算一個仆咗，其他都仲安全。

### 總結

响今日既威脅環境下，淨靠密碼已經唔夠安全。2FA 透過要求「你知道」+「你有」或「你係」，為你既帳戶多加關鍵既第二層防線。
